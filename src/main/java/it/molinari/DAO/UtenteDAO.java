...
*/ public UtenteDTO get(String codiceFiscale) throws SQLException {
	...
	public void delete(String codiceFiscale) throws SQLException {
	    // Assumi che "TRNLSN78T07F205K" sia il codice fiscale dell'amministratore che non deve essere eliminato
	    ...
	    // Procedi con l'eliminazione se il codice fiscale non corrisponde a quello dell'amministratore
	    ...
	    try (Connection conn = getConnection(); 
	        ...
	        try (ResultSet rs = stmtEsistenza.executeQuery()) {
	            if (rs.next()) {
	                ...
	                // Se count è maggiore di zero, significa che esiste già un record con lo stesso login_id
	                if (count > 0) {
