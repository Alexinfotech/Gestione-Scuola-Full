            ...
            switch (action) {
                ...
                case "mostraCarrello":
                    ...
                    if (loginId != null) {
                        ...
                        // Gestire il caso in cui non si abbia un loginId (utente non loggato o sessione scaduta)
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (idStr != null && !idStr.isEmpty()) {
            try {
                ...
                // Assumi che CarrelloService abbia un metodo delete che accetti un ID per rimuovere un prodotto dal carrello
                new CarrelloService().delete(id); // Sostituisci con il tuo servizio/carrello effettivo
                response.sendRedirect(request.getContextPath() + "/CarrelloServlet?action=list"); // Reindirizza l'utente alla lista aggiornata
