    ...
    <div id="mainContainer">
        ...
        <div class="container mt-3">
            ...
            <div class="card card-custom">
                <div class="card-header card-header-custom">Dettagli di Spedizione</div>
                <div class="card-body">
                    <p class="card-text">Nome: <%=utente.getNome()%></p>
                    <p class="card-text">Cognome: <%=utente.getCognome()%></p>
                    <p class="card-text">Via: <%=utente.getVia()%></p>
                    <p class="card-text">Civico: <%=utente.getNumeroCivico()%></p>
                    <p class="card-text">Comune di Residenza: <%=utente.getComuneDiResidenza()%></p>
                    <p class="card-text">CAP: <%=utente.getCap()%></p>
                </div>
            </div>
            <div class="text-center mt-4">
                <a href="ProdottoServlet?action=list" class="btn btn-primary btn-primary-custom">Continua gli acquisti</a>
            </div>
            <%
            } else {
            %>
