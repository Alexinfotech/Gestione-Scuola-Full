...
<body>
	...
	<div id="mainContainer">
		...
		<div id="corpoPrincipale">
			...
			<h2 style="color: #1e90ff;">Registrazione Nuovo Magazziniere</h2>
			<form id="registrazioneForm"
				action="LoginServletDB?action=registraMagazziniere" method="POST">
				...
				<button type="button" class="btn btn-secondary"
					onclick="window.location.href='views/welcome.jsp'">Torna
					alla Welcome</button>
			</form>
