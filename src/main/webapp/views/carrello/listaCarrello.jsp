                ...
                <tbody>
                    <% for (ProdottoDTO prodotto : listaCarrello) { %>
                        <tr>
                            ...
                            <td>
                                <a href="CarrelloServlet?action=delete&id=<%= prodotto.getId() %>" onclick="return confirm('Sei sicuro di voler rimuovere questo prodotto dal carrello?');" class="btn btn-danger">Rimuovi</a>
                            </td>
                        </tr>
                    <% } %>
